// Package sensors provides advanced sensor fusion capabilities for PRICILLA payload guidance.
package sensors
...
const (
	...
	SensorWiFi   SensorType = "wifi"   // WiFi CSI imaging for through-wall perception
)
...
func DefaultFusionConfig() FusionConfig {
	return FusionConfig{
		...
		FailoverPriority: []SensorType{
			SensorINS, SensorRADAR, SensorLIDAR, SensorWiFi, SensorGPS, SensorVISUAL, SensorIR,
		},
