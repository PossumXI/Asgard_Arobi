...
PRICILLA serves as the central nervous system for all guided payloads in the ASGARD ecosystem, including:
...
├── cmd\
│   └── pricilla\
│       └── main.go              # Main PRICILLA executable (v2.0.0)
├── internal\
│   ├── guidance\
...
PRICILLA integrates with all ASGARD subsystems through a unified integration layer.
...
PRICILLA v2.0 introduces a comprehensive live feed system for real-time payload tracking and mission monitoring.

### Live Feed Architecture

```
┌─────────────────────────────────────────────────────────────────────────┐
│                         PRICILLA Live Feed Hub                          │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  ┌───────────────┐    ┌───────────────┐    ┌───────────────┐          │
│  │ Telemetry     │    │ Video         │    │ Map           │          │
...
const ws = new WebSocket('wss://pricilla.asgard/feeds/feed-001');
...
The Mission Hub provides a centralized interface for monitoring and controlling all PRICILLA-guided missions with tiered access control.
...
│ └──────────────┘ │                                  │ Status: ACTIVE   │
├──────────────────┴─────────────────────────────────┴──────────────────┤
│  PRICILLA v2.0.0 | 2026-01-22 | CLEARANCE: MILITARY                   │
└────────────────────────────────────────────────────────────────────────┘
```
...
|----------|-------------|
| `PRICILLA_HTTP_PORT` | HTTP API port |
| `PRICILLA_METRICS_PORT` | Metrics port |
