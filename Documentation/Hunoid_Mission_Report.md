...
- proceed: 
- hold: Low confidence or high criticality action requires approval
- hold: Low confidence or high criticality action requires approval
- hold: Consent required for this step
- proceed: 
...
- approved (score 1.00): 
- approved (score 1.00): 
- hold (score 0.80): Consent required for this step
- approved (score 1.00): 
