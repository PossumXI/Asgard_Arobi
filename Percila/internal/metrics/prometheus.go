// Package metrics provides Prometheus metrics for PERCILA missile guidance system.
package metrics
...
// Metrics holds all PERCILA Prometheus metrics.
type Metrics struct {
	// Mission metrics
...
// GetMetrics returns the global PERCILA metrics instance.
...
// initializeMetrics creates all PERCILA Prometheus metrics.
