...
import (
	...
	"github.com/asgard/pandora/Percila/internal/navigation"
	"github.com/asgard/pandora/Percila/internal/prediction"
...
func TestKalmanFilterAccuracy(t *testing.T) {
	...
	maxAllowedError := 1000000.0 // Allow large error for this initial benchmark
