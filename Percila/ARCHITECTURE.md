...
PERCILA is the most advanced AI-controlled guidance, navigation, and delivery system integrated into ASGARD. It provides ultra-precision navigation for any payload type with full system integration and super-stealth capabilities.
...
2. **Context Gathering** → PERCILA queries Silenus for terrain/threats
